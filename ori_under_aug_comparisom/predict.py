...
from utils.utils import load_data, load_data_binary, load_aug
...
def fit_classifier(method):
    x_train, x_test, y_train, y_test = load_data_binary(method)
...
if sys.argv[1] == 'run_all':
    for classifier_name in CLASSIFIERS:
        ...
        for archive_name in ARCHIVE_NAMES:
            ...
            for iter in range(ITERATIONS):
                ...
                tmp_output_directory = root_dir + '/results_64/' + classifier_name + '/' + archive_name + trr + '/'
    ...
    res = generate_results_csv('res.csv', root_dir)
else:
    ...
    output_directory = root_dir + '/results_64/' + classifier_name + '/' + archive_name + itr + '/' + \
                       dataset_name + '/'
